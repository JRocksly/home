...
angular.module('home').config(['panelsProvider', function (panelsProvider) {
...
angular.module('home').controller('panelController',['$scope', 'panels', function ($scope, panels) {
...
angular.module('home').controller('leftPanelCtrl',['$scope', 'panels', function ($scope, panels) {

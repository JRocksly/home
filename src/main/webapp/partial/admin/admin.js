...
angular.module('home').controller('AdminCtrl',['$scope', 'CategorizationElementService', '$uibModal', 'alertService', function($scope, CategorizationElementService, $uibModal, alertService){
...
angular.module('home').controller('CategorizationElementModalCtrl', function ($scope, $uibModalInstance, selectedElement) {
